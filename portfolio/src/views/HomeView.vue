    ...
    <v-container fluid>
        <div class="head">
          <v-row>
            ...
            <v-col cols="2">
              <div style="position: absolute;z-index: 9999;bottom: 0;margin-right: auto;left: 0;right: 0;text-align: center;">
        ...
        <v-col clols="12" class="mt-16" id="about">
          <div>
            <r-row>
              <v-col cols="12" sm="6">
                <div class="egg">
              ...
              <v-col cols="12" sm="6">
                ...
                <h4 class="mt-n4">I Am a Creative Web Design</h4>
                <h4>And Deveroper</h4>
                <p class="text-grey">Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                  Rerum neque quae vero tenetur non voluptate incidunt officia veritatis 
                  reiciendis beatae doloribus nemo, dolorum voluptas esse nam consequatur 
                  suscipit praesentium aut.
              ...
              <p class="text-grey">
                ...
                Fugit, inventore! 
                Nobis sit accusantium dicta architecto itaque quisquam dolor illo quos, 
                dolorum eum illum deserunt soluta? Sed nihil sapiente atque nobis!
              </p>
              ...
              <v-col cols="12">
                <div class="child">
                  ...
                  <p class="text-grey ml-3 mt-4 text-caption">
                    Lorem, ipsum dolor sit amet <br/> consetvu adipisiving
                    <br/>consumer adding
                  </p>
                </div>
                <div class="child">
        ...
        <v-col cols="12" sm="12" id="services">
          <div class="d-flex justify-center mb-6">
            ...
            <v-btn variant="tonal">Illustlation</v-btn>
          </div>
        </v-col>
        <v-col cols="12" class="imgHober">
          <v-row class="fill-height" align="center" justify="center">
            <template v-for="(item, i) in items" :key="i">
              <v-col cols="12" md="4">
                <v-hover v-slots="{isHoving, progs}">
                  <v-card :elevation="isHoving ? 12 : 2" :class="{'on-hover' : isHovering}" v-bind="props">
        ...
        <v-col cols="12" sm="12">
          <div class="d-flex justify-center mb-6">
            <v-btn colo="white" class="mt-4">Load more</v-btn>
          </div>
        </v-col>
            ...
            <v-row>
              <v-col cols="12" sm="4">
                <v-card class="mw-auto" max-width="344" height="">
                  <v-img src="i10.png" haight="200px" cover></v-img>
                  <v-card-title>We provide you the best</v-card-title>\
                  <v-card-subtitle>
                    by AAE IdeaPro                   
                  </v-card-subtitle>
                  <v-card-text>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus ut voluptatibus magnam commodi possimus animi, deleniti labore blanditiis, incidunt assumenda sequi laborum amet, eveniet inventore aspernatur excepturi minus ipsum officia?
                  </v-card-text> 
                </v-card>
              </v-col>
            </v-row>
          ...
          <div class="hire">
            <v-row>
              <v-col cols="12" sm="8">
                ...
                <p class="text-grey">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. A eaque minus autem ab, voluptatem sint sunt vitae sapiente velit placeat. Officiis quod fuga ratione? Incidunt rerum dolores eos totam harum!
                </p>
              </v-col>
              <v-col cols="12" sm="4">
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <div class="child">
                ...
                <span class="text-caption">Your Street SYO, Aera Dream</span> <br/>
                <v-btn icon="fas fa-phone-alt" class="mt-10" variant="outlined"></v-btn><br/>
                <span class="text-caption">080-3327-2551</span><br/>
                <span class="text-caption">080-3327-2551</span><br/>
                <v-btn icon="fas fa-phone-alt" class="mt-10" variant="outlined"></v-btn><br/>
                <span class="text-caption">skrideapro@fun.ac.jp</span><br/>
                <span class="text-caption">skrideapro@fun.ac.jp</span><br/>
              </div>
            </v-col>
          </v-row>
        ...
        <v-col cols="12" sm="8">
          ...
          <v-divider></v-divider>
            <span class="text-caption">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. 
              Beatae doloremque dolores vel deleniti quaerat rem 
              odit culpa numquam distinctio non vitae, maxime quidem expedita? 
              Animi vero quam incidunt at consequuntur!
            </span>
            <v-row class="mt-10">
              <v-col cols="12" sm="6">
